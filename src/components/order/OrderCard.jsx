    ...
    >
      <div style={{ position: 'relative', height: '160px', overflow: 'hidden' }}>
        <img
          ...
          onError={(e) => {
            e.target.src =
              'https://via.placeholder.com/400x200/6C63FF/FFFFFF?text=Study+Room';
          }}
        />
        <span
          style={{
      ...
      >
        ...
        >
          {order.status === 'pending' && (
            <>⏳ অ্যাডমিন আপনার পেমেন্ট যাচাই করছেন। অপেক্ষা করুন।</>
          )}
          {order.status === 'approved' && (
            <>✅ অ্যাক্সেস চালু হয়েছে! ক্লাস করুন এবং টেলিগ্রামে জয়েন করুন।</>
          )}
          {order.status === 'rejected' && (
            <>❌ কারণ: {order.rejectReason || 'অ্যাডমিন জানাননি'}</>
          )}
        </div>
